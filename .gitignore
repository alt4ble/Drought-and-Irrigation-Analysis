...
augmented_flag_file = os.path.join(train_dir, "augmentation_done.txt")
if not os.path.exists(augmented_flag_file):
    wet_dir = os.path.join(train_dir, "wet")
    augmented_wet_dir = wet_dir

    wet_images = [f for f in os.listdir(wet_dir) if not f.startswith("aug")]
